...
const indexStatements = [
  ...
  'CREATE INDEX IF NOT EXISTS idx_referral_clicks_referrer_user_id ON referral_clicks(referrer_user_id)',
  ...
  'CREATE INDEX IF NOT EXISTS idx_feedback_messages_user_created_at ON feedback_messages(user_id, created_at DESC)',
  'CREATE INDEX IF NOT EXISTS idx_feedback_messages_featured_created_at ON feedback_messages(featured, created_at DESC)',
  'CREATE INDEX IF NOT EXISTS idx_feedback_votes_message_id ON feedback_votes(message_id)',
