  ...
  try {
    ...
    return res.json({
      ...
      data: {
        ...
        plan_duration_days: profile.plan_duration_days,
        plan_price: profile.plan_price,
        plan_price_text: profile.plan_price_text,
        home_plan_id: profile.home_plan_id,
        home_plan_name: profile.home_plan_name,
        home_plan_duration_days: profile.home_plan_duration_days,
        home_plan_price: profile.home_plan_price,
        home_plan_price_text: profile.home_plan_price_text,
        home_expire_at: profile.home_expire_at,
        home_proxy_tag: profile.home_proxy_tag,
        subscription_url: profile.subscription_ready ? urls.subscription_url : '',
        clash_url: profile.subscription_ready ? urls.clash_url : '',
